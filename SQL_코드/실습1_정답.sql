...
/*****NOT BETWEEN A AND B 연산자 사용*****/
--46. `SALARY`가 2000000에서 3000000 사이가 아닌 사원의 이름과 급여
SELECT EMP_NAME, SALARY
FROM EMPLOYEE
WHERE SALARY NOT BETWEEN 2000000 AND 3000000;
--47. `HIRE_DATE`가 2000년 1월 1일부터 2010년 12월 31일 사이가 아닌 사원의 이름과
--입사일
SELECT EMP_NAME, HIRE_DATE
FROM EMPLOYEE
WHERE HIRE_DATE
NOT BETWEEN TO_DATE('2000-01-01', 'YYYY_MM_DD') AND TO_DATE('2010-12-31', 'YYYY_MM_DD');
